...
const formSchema = z.object({
  podcastTitle: z
    .string()
    .min(2, "Podcast Name must be at least 2 characters."),
        ...
        >
          ...
          <div className="flex flex-col pt-10">
            ...
            <div>
              <Button
                type="submit"
                className="text-16 w-full bg-orange-500 py-4 font-extrabold text-white-1 transition-all duration-500 hover:bg-black"
              >
                {isSubmitting ? (
                  <>
...
//         toast.warning("Please generate audio and image")
