...
//     } catch (error) {
//       console.log("Error genrating podcast", error);
...
//         </Label>
//         <Textarea
//           className="input-class font-light focus-visible:ring-orange-300"
...
const useGeneratePodcast = ({
  ...
  const generatePodcast = async () => {
    ...
    if (!voicePrompt) {
      toast.warning("Please provide a voiceType to generate a podcast");
      return setIsGenerating(false);
    }
